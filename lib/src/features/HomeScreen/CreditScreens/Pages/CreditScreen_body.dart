...
import 'package:what_the_crush_app/src/features/HomeScreen/CreditScreens/Pages/annualplan_bottomsheet.dart';
import 'package:what_the_crush_app/src/features/HomeScreen/CreditScreens/Pages/create_gang_bottomsheet.dart';
import 'package:what_the_crush_app/src/features/HomeScreen/CreditScreens/Pages/subscribed_bottomsheet.dart';
...
class CreditScreen_body extends StatefulWidget {
  const CreditScreen_body({super.key});

  @override
  State<CreditScreen_body> createState() => _CreditScreen_bodyState();
}

class _CreditScreen_bodyState extends State<CreditScreen_body> {
            ...
            GestureDetector(
              onTap: () {
                showModalBottomSheet(
                    ...
                    context: context,
                    builder: (BuildContext context) {
                      return annualplan_bottomsheet();
                    });
              },
              child: CreditsContainer1(
                txt: 'annual plan',
                  ...
                  Container_rowcontent(
                    onPressed: () {
                      showModalBottomSheet(
                          ...
                          context: context,
                          builder: (BuildContext context) {
                            return subscribed_BottomSheet2();
                          });
                    },
                    text4: 'subscribe',
                    text3: '0',
