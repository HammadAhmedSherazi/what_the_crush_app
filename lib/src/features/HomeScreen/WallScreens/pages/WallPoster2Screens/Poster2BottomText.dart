...
import 'package:what_the_crush_app/src/features/HomeScreen/WallScreens/pages/WallPoster2Screens/view/Poster2Undo_Sheet.dart';
...
class poster2_BottomText extends StatefulWidget {
  const poster2_BottomText({super.key});

  @override
  State<poster2_BottomText> createState() => _poster2_BottomTextState();
}

class _poster2_BottomTextState extends State<poster2_BottomText> {
  @override
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => poster2BottomUndo()));
                          },
                          child: Container(
                            width: 100.w,
                            height: 50.h,
                            ...
                            child: Center(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: 8
                                          .w), // Adding spacing between icon and text
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    crossAxisAlignment:
