...
import 'package:what_the_crush_app/src/features/HomeScreen/GangScreen/connectedgangs_body.dart';
import 'package:what_the_crush_app/src/features/HomeScreen/GangScreen/friends_body.dart';
import 'package:what_the_crush_app/src/features/HomeScreen/GangScreen/gang_filterButtons.dart';
import 'package:what_the_crush_app/src/features/HomeScreen/GangScreen/mygang_body.dart';
...
class GangScreen extends StatefulWidget {
  const GangScreen({Key? key}) : super(key: key);
                    ...
                    child: PageView(
                      ...
                      children: [
                        ...
                        FriendsBody(),
                          ...
                          .map(
                              (widget) => Builder(builder: (context) => widget))
                          .toList(),
                    ),
                  ),
                ),
