...
import 'package:what_the_crush_app/src/features/HomeScreen/CrushScreen/widgets/message_sheet.dart';
...
class ResetSupportSheet extends StatefulWidget {
  const ResetSupportSheet({super.key});

  @override
  State<ResetSupportSheet> createState() => _ResetSupportSheetState();
}

class _ResetSupportSheetState extends State<ResetSupportSheet> {
  String? selectedValue;
  @override
  Widget build(BuildContext context) {
    return DraggableScrollableSheet(
      initialChildSize: 0.97, // Set the initial size of the sheet
      minChildSize: 0.70, // Set the minimum size of the sheet
      maxChildSize: 1.0, // Set the maximum size of the sheet
      expand: true, // Set to true for full screen
                              ...
                              onPressed: () {
                                showModalBottomSheet(
                                  ...
                                  builder: (BuildContext context) {
                                    return message_sheet();
                                  },
                                );
                              },
                              text: '   send discreet crush message',
                            ),
                            10.verticalSpace,
                          ],
                        ),
